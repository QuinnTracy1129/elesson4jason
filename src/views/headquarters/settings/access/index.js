...
export default class extends Component {
    ...
    onSearch = () => {
        tanong(this.state.entity, this.key.value).then(data => {
                    ...
                    <td>
                        <ButtonGroup>
                            <Popover content="Edit" >
                                <Button className="btn btn-outline-info" onClick={this.onExhibit.bind(this, index, id)}>
                                    <FontAwesomeIcon icon={faEdit} />
                                </Button>
                            </Popover>
                            <Popover content="Delete" placement="right" >
                                <Button className="btn btn-outline-danger" onClick={this.onDelete.bind(this, index, id)}>
