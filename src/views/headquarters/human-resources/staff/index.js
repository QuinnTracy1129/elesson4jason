...
import { faHandHolding, faTrash } from "@fortawesome/free-solid-svg-icons";
...
export default class extends Component {
  ...
  onGrant = async () => {
    await Swal.fire({
      ...
      inputOptions: {
        Platforms: {
          aEnrollment: "Enrollment",
          aAdmission: "Admission",
          aSF: "School Form",
          aPageant: "Pageant",
          aInventory: "Inventory",
          aAccounting: "Accounting",
          aAttendance: "Attendance",
          aTracking: "Tracking",
          aGaa: "Gaa",
          aPoll: "Poll",
          aTabulation: "Tabulation",
        },
      },
      inputPlaceholder: "Select a platforms",
      showCancelButton: true,
      inputValidator: (value) => {
        return new Promise((resolve) => {
          if (value) {
            alert(`You have access to ${value}`);
            resolve();
          } else {
            ...
            <ButtonGroup>
              <Popover content="View" placement="left">
                <Button
                  ...
                  onClick={this.onGrant.bind(this, index)}
                >
