...
export async function baguhin(entity, pk, params, withMsge = true) {
  return await axios
    .put(`api/${entity}/${pk}/update`, params)
    .then((res) => {
      if (withMsge) {
        swal.fire({
          position: "top-end",
...
export async function baguhinOitala(entity, params) {
  return await axios
    .put(`api/${entity}/updateOrCreate`, params, { validateStatus: () => true })
    .then((res) => res)
    .catch((err) => {
      console.log(err);
    });
